...
CubeModel::CubeModel(LoadFiles* FH)
	: CubeModel()
{
...
bool CubeModel::Update(glm::mat4 view, glm::mat4 model)
{
	//set up model view
	...
	Scales = glm::vec3(0.50f, 0.50f, 0.50f);
	...
	glm::mat4 View  = glm::lookAt(
								glm::vec3(10, 10, 24),// camera position
		 // Camera is at (17,23,3), in World Space
								glm::vec3(0, 0, 0), //camera position + frontal position 
		 // look at the origin

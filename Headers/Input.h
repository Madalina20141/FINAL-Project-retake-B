...
#define SCREENWIDTH 1920	// this is a hard coded value it would be better to have it set to the variable size of the screen since we can't always be sure
#define SCREENHEIGHT 1080	// that we will be using a full 1080p screen
